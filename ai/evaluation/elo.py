...
from ai.evaluation.evaluator import MatchResult, play_networks_parallel, play_agents
...
class EloTracker:
    ...
    def play_match_parallel(network_a, network_b, num_games: int,
        ...
        Delegates to evaluator.play_networks_parallel.
        """
        return play_networks_parallel(
            network_a, network_b, num_games,
    ...
    def evaluate_latest(self, make_agent_fn: Callable[[str], object],
        ...
        for opp in opponents:
            ...
            match = play_agents(latest_agent, opp_agent, num_games)
    ...
    def run_tournament(self, make_agent_fn: Callable[[str], object],
        ...
        for i, name_a in enumerate(names):
            for name_b in names[i + 1:]:
                match = play_agents(agents[name_a], agents[name_b], num_games)
